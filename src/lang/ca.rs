...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connexió a la xarxa XeDesk en progrés..."),
        ...
        ("android_input_permission_tip1", "Per a que un dispositiu remot controli el seu dispositiu Android amb el ratolí o tocs, cal permetre que XeDesk utilitzi el servei d' \"Accesibilitat\"."),
        ("android_input_permission_tip2", "Vés a la pàgina de [Serveis instal·lats], activa el servei [XeDesk Input]."),
        ...
        ("Turned off", "Apagat"),
        ("Language", "Idioma"),
        ("Keep XeDesk background service", "Mantenir XeDesk com a servei en segon pla"),
