<p align="center">
  ...
  <b>Нам потрібна ваша допомога для перекладу цього README, <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">інтерфейсу</a> та <a href="https://github.com/rustdesk/doc.fuxiaoer.top">документації</a> RustDesk на вашу рідну мову</B>
</p>
...
## [Збирання](https://www.fuxiaoer.top/docs/en/dev/build/)
