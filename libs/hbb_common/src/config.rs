...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("XeDesk".to_owned());
...
pub const LINK_DOCS_HOME: &str = "https://www.fuxiaoer.top/docs/en/";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://www.fuxiaoer.top/docs/en/manual/linux/#x11-required";
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["www.fuxiaoer.top"];
pub const PUBLIC_RS_PUB_KEY: &str = "T8MuSfoaz99wPn8K1aC4VHNjKNBUwpJE3MsAzzEyWCI=";
